...
var _user$project$Mylib$getCurrentTime = _user$project$Native_Mylib.getCurrentTime;
var _user$project$Mylib$print = function (value) {
	return _user$project$Native_Mylib.log(
		_elm_lang$core$Basics$toString(value));
};

var _user$project$Test$tests = A2(
	_elm_community$elm_test$ElmTest$suite,
	'elm-Mylib Library Tests',
	_elm_lang$core$Native_List.fromArray(
		[]));
var _user$project$Test$main = {
	main: _elm_community$elm_test$ElmTest$runSuite(_user$project$Test$tests)
};

var Elm = {};
Elm['Test'] = Elm['Test'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Test'], 'Test', typeof _user$project$Test$main === 'undefined' ? null : _user$project$Test$main);
